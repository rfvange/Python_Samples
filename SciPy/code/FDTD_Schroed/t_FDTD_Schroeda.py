# From http://www.scipy.org/Cookbook/SchrodingerFDTD
# Found in http://www.scipy.org/Cookbook
# Good reference: http://www.acronymfinder.com/FTDT.html
#  Finite-Difference Time-Domain (method)
# Used in the field of physical chemistry.
...
THCK = 5       # "Thickness" of the potential barrier (if appropriate
